...
public class Core100RuleTests : CategoryMilestoneRuleTestBase<Core100Rule>
{
    protected override string Category => TrainingCategories.Core;
    protected override string AchievementId => AchievementIds.Core100;
    protected override int Milestone => 100;
    
    protected override Core100Rule CreateRule(ApplicationDbContext context, Mock<IAchievementService> achievementMock)
    {
        return new Core100Rule(context, new Lazy<IAchievementService>(() => achievementMock.Object));
    }
