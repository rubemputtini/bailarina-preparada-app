    ...
    >
      ...
      <Stack direction="column" justifyContent="space-between" flex={1} gap={{ xs: 4, sm: 2 }}>
        ...
        <Stack direction="row" flexWrap="wrap" alignItems="center" gap={2}>
          <InfoBar 
            icon={<EmailOutlined sx={{ color: "#808191"}} />} name={email}        
          />
          <InfoBar 
            icon={<Place sx={{ color: "#808191"}} />} name="Porto"        
          />
          <InfoBar 
            icon={<Phone sx={{ color: "#808191"}} />} name="+351 999-999-999"        
          />
          <InfoBar 
            icon={<LocationCity sx={{ color: "#808191"}} />} name={`${noOfProperties} Properties`}        
          />
        </Stack>
      </Stack>
    </Box>
